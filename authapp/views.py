...
#         SelectWorkout=request.POST.get('lorkout')
#         TrainedBy=request.POST.get('trainer')
#         query=Attendance(phonenumber=phonenumber,Login=Login,Logout=Logout,SelectWorkout=SelectWorkout,TrainedBy=TrainedBy)
#         query.save()
...
#         query=Enrollment(FullName=Fullname,Email=email, Gender=gender,PhoneNumber=PhoneNumber,SelectMembership=Member,DOB=DOB, SelectTrainer=Trainers,Reference=Reference,Address=Address)
#         query.save()
